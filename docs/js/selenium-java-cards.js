/**
 * Renders Selenium Java project cards from window.SELENIUM_JAVA_PROJECTS.
 * Details open in a modal popup. Data lives in data/selenium-java-projects.js.
 */
(function () {
  var GITHUB_BASE = "https://github.com/pelin-dragos/QA-Automation/tree/main/selenium-java-tests/";
  ...
  function init() {
    var container = document.getElementById("selenium-java-project-cards");
    var data = window.SELENIUM_JAVA_PROJECTS;
